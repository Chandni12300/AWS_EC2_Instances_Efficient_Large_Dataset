...
#define NUM_ROWS_A 1208 //rows of input [A]
#define NUM_COLUMNS_A 1208 //columns of input [A]
#define NUM_ROWS_B 1208 //rows of input [B]
#define NUM_COLUMNS_B 1208 //columns of input [B]
